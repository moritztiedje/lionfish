...
class View(metaclass=ABCMeta):
    def __init__(self, game_window):
        """
        :type game_window: src.main.gameWindow.GameWindow
        """
...
class AreaMapView(View):
    ...
    def __display_hexagon(self, sprite, coordinate):
        """
        :type coordinate: main.GUI.point.Point
        """
        x_coordinate = coordinate.get_x() * HEXAGON_FIELD_WIDTH_SPACING * self._camera_zoom
        y_coordinate = coordinate.get_y() * HEXAGON_FIELD_HEIGHT * self._camera_zoom
