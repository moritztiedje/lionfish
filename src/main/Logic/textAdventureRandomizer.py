from src.main.Logic.stateMachine import ChoiceState, SuccessState, FailState, ForwardingState
...
class TextAdventureRandomizer:
    ...
    def choose_adventure():
        ...
        initial_state.add_next_state("Proceed.", SuccessState("You completed the area."))
        initial_state.add_next_state("Look around", look_around)
        initial_state.add_next_state("Run Away", FailState("You ran away."))
